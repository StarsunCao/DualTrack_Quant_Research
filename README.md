...
| `deepseek-r1-14b` | 本地 (MacBook Air M2) | A股 + 美股 | DeepSeek R1 14B 蒸馏版 |
| `deepseek-r1-8b` | 本地 (MacBook Air M2) | A股 + 美股 | DeepSeek R1 8B 轻量版 |
| `qwen3.5` | 云端 (SiliconFlow) | 仅美股 | Qwen3.5 397B 满血版 |
| `qwen3.5-9b` | 本地 (MacBook Air M2) | 待实验 | Qwen3.5 9B 可部署版 |
